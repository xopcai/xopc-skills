...
> **XOPC adaptation:** use supplied or authorized data, label assumptions, and never guarantee rankings, reach, conversion, or revenue; protect informed choice: reject deceptive scarcity, hidden costs, coercion, sensitive-trait targeting, and dark patterns.
