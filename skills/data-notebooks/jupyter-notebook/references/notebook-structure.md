...
Prefer scaffolding from the bundled templates or `new_notebook.py`, resolved relative to this Skill's installed directory, instead of hand-authoring raw notebook JSON.
